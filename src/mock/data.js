...
export const projectsData = [
  ...
  },
  {
    ...
    info: 'Implement published ridge regression ML model which uses NLP derived features from dense, high dimensional Twitter data to predict excessive alcohol consumption.',
    info2:
  ...
  },
  {
    ...
    info: 'Extract, transform, and load large Twitter datasets for use in multiple ML models using Academic Research Twitter API endpoints.',
    info2:
  ...
  },
  {
    ...
    info: 'Create single-page application which explores film soundtracks, intelligently recommends relevant artists / films / songs, and plays embedded spotify tracks.',
    info2:
  ...
  },
  {
    ...
    title: 'PennPals (2020)',
    info: 'Design and create a WhatsApp clone using MERN stack and Twilio Conversations API.',
    info2:
